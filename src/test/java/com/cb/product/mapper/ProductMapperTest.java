...
class ProductMapperTest {
    ...
    void productToProductRecordTest() {
        ...
        Product product = new Product("6590722a46eb225aac1cfd22", "iPhone 14",
                new BigDecimal("58999"), "iPhone 14 (128 GB) - Midnight", LONG_DESC_1,
        ...
        assertEquals(LONG_DESC_1, productRecord.longDesc());
    ...
    void productsToProductRecordsTest() {
        ...
        Product product2 = new Product("6590722a46eb225aac1cfd23", "iPhone 13",
                new BigDecimal("30.30"), "iPhone 13 (128GB) - Purple", LONG_DESC_2,
        ...
        assertEquals(LONG_DESC_2, productRecord.longDesc());
    ...
    void productRecordToProductTest() {
        ...
        ProductRecord productRecord = new ProductRecord("6590722a46eb225aac1cfd22", "iPhone 14", new BigDecimal("58999"),
                "iPhone 14 (128 GB) - Midnight", LONG_DESC_1, "https://https://testimage.com/iphone14/image1.png.com/iphone14/thumbnail.png", "https://testimage.com/iphone14/image1.png",
